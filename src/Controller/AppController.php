...
class AppController extends Controller
{
    ...
    public function initialize()
    {
        ...
        $this->loadComponent('Auth', ['authorize' => ['Controller'],
                                      ...
                                      'loginError' => 'El nombre de usuario y/o la contraseña no son correctos. Inténtelo nuevamente.',
                                      'unauthorizedRedirect' => ['controller'=>'pages', 'action'=>'unauthorized'],
                                     ]);
    ...
    protected function normalizar($string)
    {
        $string = trim($string);
