...
setlocale(LC_ALL, 'es_AR', 'es_AR.utf-8', 'es_AR.utf-8', 'spanish');
...
Inflector::rules('singular', ['/tes$/' => 'te',        // sacerdotes => sacerdote
                              '/es$/' => '',           // errores    => error
                              '/s$/'  => '',           // vacas      => vaca
                             ]);


//Inflector::rules('irregular', ['foja' => 'funcion_sacerdote_institucion',]);
...
Configure::write('Theme', ['title' => 'Arzo',
                           'logo'  => ['mini' => 'Arzo',
                                       'large' => 'Arzobispado'],
